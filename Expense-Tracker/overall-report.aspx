<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="overall-report.aspx.cs" Inherits="Expense_Tracker.Expense_Tracker.overall_report" %>
...
<head id="Head1" runat="server">
    ...
    <title>Expense Tracker | Over All Report</title>
    ...
    <form id="form1" runat="server">
        ...
        <header class="sticky">
            ...
            <ul class="navlist">
                ...
                <li>&nbsp;/&nbsp;Over All Report</li>
            </ul>
        </header>

        <!-- main section-->
        <section class="income_main">
        <div class="text-center">Over All Report</div>
        <div class="heading_date">
            <div>
                <span>
                    <asp:DropDownList ID="ddlSort" runat="server" AutoPostBack="true" class="ddl">
                        ...
                        <asp:ListItem Value="by_whom" Text="By Whom"></asp:ListItem>
                        <asp:ListItem Value="to_whom" Text="To Whom"></asp:ListItem>
                        <asp:ListItem Value="category" Text="Category"></asp:ListItem>
                        <asp:ListItem Value="pay_type" Text="Payment Type"></asp:ListItem>
                        <asp:ListItem Value="id" Text="Number Range"></asp:ListItem>
                    </asp:DropDownList>
                </span>
            </div>
            <div>
                <span>
                    <asp:Button ID="btnSort" class="income_btn" runat="server" Text="Sort" OnClick="btnSort_Click"/><br />
                </span>
            </div>
        </div> 
        ...
        <HeaderTemplate>
                <div class="heading">
                    ...
                    <div class="heading_sub9">Delete</div>
                </div>
                </HeaderTemplate>
                ...
                <div class="data">
                    ...
                    <div class="heading_sub9"><asp:Button ID="DeleteButton" runat="server" class="UpDeBtn" Text="Delete" CommandArgument='<%# Eval("id") %>' OnClick="DeleteButton_Click"></asp:Button></div>
                </div>
            </ItemTemplate>
            </asp:Repeater>
                <div class="print">
