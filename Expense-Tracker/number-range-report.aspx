<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="number-range-report.aspx.cs" Inherits="Expense_Tracker.Expense_Tracker.number_range_report" EnableEventValidation="False" %>
...
<head id="Head1" runat="server">
    ...
    <title>Expense Tracker | Number Rande Report</title>
    ...
    <form id="form1" runat="server">
        ...
        <header class="sticky">
            ...
            <ul class="navlist">
                ...
                <li>&nbsp;/&nbsp;Number Range Report</li>
            </ul>
        </header>

        <!-- main section-->
        <section class="income_main">
        <div class="text-center">Number Range Report</div>
