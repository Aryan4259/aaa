<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="date-report.aspx.cs" Inherits="Expense_Tracker.Expense_Tracker.date_report" EnableEventValidation="False" %>
...
<head id="Head1" runat="server">
    ...
    <title>Expense Tracker | Date wise Report</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="text-center">Date Report</div>
            ...
            <asp:Repeater ID="IncomeRepeater" runat="server">
                ...
                <ItemTemplate>
                    <div class="data">
                        ...
                        <div><div class="heading_sub9"><asp:Button ID="EditButton" runat="server" class="UpDeBtn" Text="Edit" OnClick="EditButton_Click"></asp:Button></div>
                        </div><div class="heading_sub10"><asp:Button ID="DeleteButton" runat="server" class="UpDeBtn" Text="Delete" CommandArgument='<%# Eval("id") %>' OnClick="DeleteButton_Click"></asp:Button></div>
                    </div>
                </ItemTemplate>
            </asp:Repeater>
                <div class="print">
