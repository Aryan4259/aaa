<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="date-report-edit.aspx.cs" Inherits="Expense_Tracker.Expense_Tracker.date_report_edit" %>
    ...
    <form id="Form1" runat="server">
        ...
        <header class="sticky">
            ...
            <ul class="navlist">
                ...
                <li><a href="date-report.aspx" style="color: #000000">/Date Report</a></li>
                <li><a>/Edit</a></li>
            </ul>
        </header>
