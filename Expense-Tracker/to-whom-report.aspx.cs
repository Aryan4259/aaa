...
{
    public partial class to_whom_report : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                string query = "select DISTINCT to_whom from [transaction] where mno=" + MNO + " order by to_whom";
                ...
                DropDownList1.DataTextField = "to_whom";
                DropDownList1.DataValueField = "to_whom";
        ...
        protected void btnAddIncome_Click(object sender, EventArgs e)
        {
            string MNO = Session["MobileNumber"].ToString();
            string conn_str = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=D:\\Expense-Tracker\\Expense-Tracker\\App_Data\\Database1.mdf;Integrated Security=True";
            string query = "select * from [transaction] where to_whom='" + DropDownList1.SelectedItem.Text + "' and mno=" + MNO + "";
        ...
        {
            Response.Redirect("to-whom-report-edit.aspx");
        }
    }
}