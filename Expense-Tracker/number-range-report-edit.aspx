<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="number-range-report-edit.aspx.cs" Inherits="Expense_Tracker.Expense_Tracker.number_range_report_edit" %>
    ...
    <form id="Form1" runat="server">
        ...
        <header class="sticky">
            ...
            <ul class="navlist">
                ...
                <li><a href="number-range-report.aspx" style="color: #000000">/ Number Range Report</a></li>
                <li><a>/ Edit</a></li>
            </ul>
        </header>
