<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="category-report-edit.aspx.cs" Inherits="Expense_Tracker.Expense_Tracker.category_report_edit" %>
    ...
    <form id="Form1" runat="server">
        ...
        <header class="sticky">
            ...
            <ul class="navlist">
                ...
                <li><a href="category-report.aspx" style="color: #000000">/Category Report</a></li>
                <li><a>/Edit</a></li>
            </ul>
        </header>
